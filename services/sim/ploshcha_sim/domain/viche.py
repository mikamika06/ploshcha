...
# повтор у репліці.
HARM_ROOTS = (
    "повішу", "повісит", "вішаюс", "втоплюс", "утоплюс", "втоплю себ", "застрелю", "застрілю",
    "заріжу себ", "вб'ю себе", "вбю себе", "вбити себе", "самогубств", "суїцид", "не хочу жити",
...
def about_self_harm(text: str) -> bool:
    """Чи говорить це про намір нашкодити собі. Тільки корені — без «розумного» здогаду."""
    low = " ".join((text or "").lower().replace("’", "'").split())
    return any(root in low for root in HARM_ROOTS)
